...
const { addNewProduct, fetchAllProductsAvailable, updateExistingProduct, fetchProductAvgRatings, fetchProductRatings, deleteSingleProductbyID, } = require('../controllers');
...
productRouter.delete('/product/:productId', authenticate, checkOwner, checkIfProductExists, deleteSingleProductbyID);
